...
function promo_rule(int $vip_level): array {
  ...
  if ($vip_level === 1) { // VIP 1 Gold
    return ["diskon_persen" => 15, "bonus_kg" => 1, "bonus_min_kg" => 5, "gratis_ongkir" => true];
  }
  ...
  if ($vip_level === 3) { // VIP 3 Bronze
    return ["diskon_persen" => 5, "bonus_kg" => 0, "bonus_min_kg" => 0, "gratis_ongkir" => false];
  }
...
<div class="card">
  ...
  <div class="member-box">
    <div>
      ...
      <?php
        $cls = "vip-basic";
        if ($vip_level === 1) $cls = "vip-gold";
        elseif ($vip_level === 2) $cls = "vip-silver";
        elseif ($vip_level === 3) $cls = "vip-bronze";
      ?>
